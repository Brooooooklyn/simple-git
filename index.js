  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'x64') {
      if ((process.config && process.config.variables && process.config.variables.shlib_suffix === 'dll.a') || (process.config && process.config.variables && process.config.variables.node_target_type === 'shared_library')) {
        try {
          return require('./simple-git.win32-x64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
          const binding = require('@napi-rs/simple-git-win32-x64-gnu')
          const bindingPackageVersion = require('@napi-rs/simple-git-win32-x64-gnu/package.json').version
          if (bindingPackageVersion !== '1.2.0' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
            throw new Error(`Native binding package version mismatch, expected 1.2.0 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
          }
          return binding
    ...
    if (process.arch === 'x64') {
      ...
      if (isMusl()) {
        try {
          return require('./simple-git.linux-loong64-musl.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
          const binding = require('@napi-rs/simple-git-linux-loong64-musl')
          const bindingPackageVersion = require('@napi-rs/simple-git-linux-loong64-musl/package.json').version
          if (bindingPackageVersion !== '1.2.0' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
            throw new Error(`Native binding package version mismatch, expected 1.2.0 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
          }
          return binding
        ...
        try {
          return require('./simple-git.linux-loong64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
          const binding = require('@napi-rs/simple-git-linux-loong64-gnu')
          const bindingPackageVersion = require('@napi-rs/simple-git-linux-loong64-gnu/package.json').version
          if (bindingPackageVersion !== '1.2.0' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
            throw new Error(`Native binding package version mismatch, expected 1.2.0 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
          }
          return binding
...
if (!nativeBinding || forceWasi) {
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === 'wasm32-wasi')) {
    ...
    try {
      candidateError = __napiWasiResolveCandidate('./simple-git.wasi.cjs', false, ['./simple-git.wasm32-wasi.debug.wasm', './simple-git.wasm32-wasi.wasm'])
      candidateFailed = candidateError !== null
      if (!candidateFailed) {
        wasiBinding = require('./simple-git.wasi.cjs')
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === 'wasm32-wasi')) {
    ...
    let candidateFailed = false
    try {
      candidateError = __napiWasiResolveCandidate('@napi-rs/simple-git-wasm32-wasi', true, undefined)
      candidateFailed = candidateError !== null
      if (!candidateFailed) {
        if (process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          const bindingPackageVersion = require('@napi-rs/simple-git-wasm32-wasi/package.json').version
        ...
        wasiBinding = require('@napi-rs/simple-git-wasm32-wasi')
        nativeBinding = wasiBinding
        __napiLoadedBindingTarget = 'wasm32-wasi'
        wasiBindingLoaded = true
      }
...
module.exports.TreeBuilder = nativeBinding.TreeBuilder
...
module.exports.diffBuffers = nativeBinding.diffBuffers
