...
use crate::{CodeInto, ensure_alive};
...
pub struct Reference {
  ...
  /// Guards every method that derefs the underlying `git2::Reference`.
...
impl Reference {
  ...
  pub fn is_branch(&self) -> crate::Result<bool> {
  ...
  pub fn is_note(&self) -> crate::Result<bool> {
    ensure_alive(&self.alive)?;
  ...
  pub fn is_remote(&self) -> crate::Result<bool> {
    ensure_alive(&self.alive)?;
  ...
  pub fn is_tag(&self) -> crate::Result<bool> {
    ensure_alive(&self.alive)?;
    Ok(self.inner.is_tag())
  }

  #[napi]
  pub fn kind(&self) -> crate::Result<ReferenceType> {
    ensure_alive(&self.alive)?;
  ...
  pub fn shorthand(&self) -> crate::Result<Option<String>> {
    ensure_alive(&self.alive)?;
    Ok(self.inner.shorthand().ok().map(|s| s.to_string()))
  }
  ...
  /// not a symbolic one).
  pub fn target(&self) -> crate::Result<Option<String>> {
    ensure_alive(&self.alive)?;
    Ok(self.inner.target().map(|oid| oid.to_string()))
  }
  ...
  pub fn target_peel(&self) -> crate::Result<Option<String>> {
    ensure_alive(&self.alive)?;
    Ok(self.inner.target_peel().map(|oid| oid.to_string()))
  }
