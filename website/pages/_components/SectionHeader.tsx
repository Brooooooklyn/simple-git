...
// Presentational (server-rendered) section header: eyebrow (`NN — LABEL`), display
// title, optional subhead. Un-prefixed because it holds no client state — it hydrates
// as part of the regular route's full-page hydration but needs no interactivity.
